...
const About = () => {
    return (
        ...
        <section id='about' className='lg:mx-5'>
            ...
            <div className="hero">
                <div className="hero-content flex-col-reverse lg:flex-row">
                    ...
                    <div>
                        ...
                        <p>Iam Nabiur Siddique. Iam currently studing in computer science and technology at RIMT University, India. And Iam in my last semester.
                            <br />
                            <br />
